...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon-teal':   '0 0 8px rgba(45, 212, 191, 0.6), 0 0 24px rgba(45, 212, 191, 0.3)',
      ...
      keyframes: {
        'pulse-neon': {
          '0%,100%': { boxShadow: '0 0 10px rgba(13,148,136,0.4), 0 0 30px rgba(13,148,136,0.15)' },
          '50%':      { boxShadow: '0 0 20px rgba(13,148,136,0.8), 0 0 60px rgba(13,148,136,0.4), 0 0 100px rgba(13,148,136,0.2)' },
        },
        'pulse-red': {
